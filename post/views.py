    ...
    @extend_schema(
        ...
        parameters=[
            OpenApiParameter(
                ...
                description="access token (예: Bearer $(token))",
                required=True,
            )
        ]
    )
...
class PostDetailView(APIView):
    ...
    @extend_schema(
        ...
        responses={200: PostSerializer, 404: "Not Found", 400: "Bad Request", 401: "Unauthorized", 403: "Forbidden"},
    )
...
class LikeView(APIView):
    @extend_schema(
        ...
        request=SignInRequestSerializer,
        responses={200: PostSerializer, 404: "Not Found", 401: "Unauthorized"},
    )
